...
**To see the Dashboard 3 (Real-Time Sales Insights) the TabPy extention must be set!**

To simulate a data flow for implementing the batch approach, a *.py* file can be used.
The following dataset was used for visualization: https://www.kaggle.com/datasets/bhanuthakurr/cleaned-contoso-dataset/data.
During the project's implementation the original data was modified to correspond the task.
